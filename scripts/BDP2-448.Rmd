...
```{r}
df %>%
  select(id, sex, time, bedding, foodIntakeNormalized) %>%
...
`r test1 %>% filter(contrast == "beddingB + beddingB:time48 = 0") %>% pull(effsize) %>% sprintf("%.3g", .)` mg/g
`r test1 %>% filter(contrast == "beddingB + beddingB:time48 = 0") %>% pull(direction)`
with bedding type B compared to A
(p-value: `r test1 %>% filter(contrast == "beddingB + beddingB:time48 = 0") %>% pull(pvalue) %>% sprintf("%.2g", .)`).
...
`r test2 %>% filter(contrast == "beddingB + beddingB:sexM = 0") %>% pull(effsize) %>% sprintf("%.3g", .)` mg/g
`r test2 %>% filter(contrast == "beddingB + beddingB:sexM = 0") %>% pull(direction)`
with bedding type B compared to A
(p-value: `r test2 %>% filter(contrast == "beddingB + beddingB:sexM = 0") %>% pull(pvalue) %>% sprintf("%.2g", .)`).
At 48 hours, food intake is
